        ...
        >
          ...
          <div className="w-full md:w-2/5 relative overflow-hidden hidden md:block">
            ...
            <div className="absolute inset-0 z-20 p-8 flex flex-col justify-end">
              ...
              >
                ...
                <p className="text-white/90 text-sm mb-4">Join thousands of restaurant owners who trust FoodLoft.</p>
          ...
          <div className="w-full md:w-3/5 p-6 md:p-8 overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              >
                <div className="w-8 h-8 bg-gradient-to-r from-[#FF4F18] to-[#FF8F6B] rounded-xl flex items-center justify-center mr-2">
